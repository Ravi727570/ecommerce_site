...
const productsArr = [ 
  { title: "Colors", price: 12.99, imageUrl: "https://prasadyash2411.github.io/ecom-website/img/Album%201.png", }, 
  { title: "Black and white Colors", price: 9.99, imageUrl: "https://prasadyash2411.github.io/ecom-website/img/Album%202.png", }, 
  { title: "Yellow and Black Colors", price: 11.99, imageUrl: "https://prasadyash2411.github.io/ecom-website/img/Album%203.png", }, 
  { title: "Blue Color", price: 14.99, imageUrl: "https://prasadyash2411.github.io/ecom-website/img/Album%204.png", }, 
]; 
const Store = () => {
   ...
   const [showForm, setShowForm] = useState(false); // navigate 
   ...
   const fetchFilms = useCallback(async () => { 
    try { 
      ...
      const filmsWithImages = data.results.map((film, index) => (
        { ...film, imageUrl: productsArr[index % productsArr.length].imageUrl, 
      ...
      const productElements = useMemo(() => { 
        ...
        alt={product.title} 
        className="product-image d-block mx-auto img-fluid" 
        ...
        <div className="card-body text-center"> 
          ...
          > Add to cart</button> 
          </div> {/* Display movies info below images only if Load Movies clicked */} 
          {showMovies && films[index] && ( <div className="mt-3 text-start"> 
            <p> <strong>Episode:</strong> {films[index].episode_id} </p> 
            <p> <strong>Director:</strong> {films[index].director} </p> 
            <p> <strong>Release Date:</strong> {films[index].release_date} </p> 
            </div> 
            )} 
            </div> 
            )); 
          ...
          <header className="bg-secondary text-center py-5"> 
            ...
            </header> <main className="flex-grow-1"> 
              <section className="container my-5 text-center"> 
                <h2 className="fw-bold">MUSIC</h2> 
                {/* Add Movie Button */} 
                <div className="mb-3"> 
                  <button className="btn btn-success" style={{ width: "15%" }} 
                ...
                {/* Add Movie Form */} 
                {showForm && ( 
                  <AddMovieForm onAddMovie={(movie) => { console.log("New Movie Added:", movie); 
                ...
                <div className="mb-3"> 
                  ...
                  onClick={() => { setShowMovies(true); setCancelRetry(false); fetchFilms(); 
